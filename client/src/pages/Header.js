...
export default function Headers(props) {
    ...
    function scrollandresize() {
        ...
        if(window.scrollY >= 115 || window.innerWidth <= 600){
            ...
            menu.style.top = "34px"
            menuH.style.fontSize = "18px"
            menuH.style.top = "33px"
            menuH.style.right = "62px"
        ...
        <>
            ...
            <div id="navPage" className="NavRed">
                ...
                <div className="navigation">
                    <Link to={"/"}><h1 className="ul">HOME</h1></Link>
                    <Link to={"/"}><h1 className="ul">BOOKS</h1></Link>
                    <Link to={"/"}><h1 className="ul">BROWSE</h1></Link>
                    <Link to={"/"}><h1 className="ul">ABOUT US</h1></Link>
                    <Link to={"/"}><h1 className="ul">DONATE</h1></Link>
                    <div className="here">
            ...
            <div className="header-div">
                ...
                <div className="menuLink" onMouseEnter={() => {hover()}} onMouseLeave={() => closeBack()} onClick={() => openMenu()}>
