        ...
        <>
            ...
            <div id="navPage" className="NavRed">
                ...
                <div className="navigation">
                    <Link to={"/"} onClick={() => hideMenu()}><h1 className="ul">HOME</h1></Link>
                    <Link to={"/"} onClick={() => hideMenu()}><h1 className="ul">BOOKS</h1></Link>
                    <Link to={"/browse"} onClick={() => hideMenu()}><h1 className="ul">BROWSE</h1></Link>
                    <Link to={"/"} onClick={() => hideMenu()}><h1 className="ul">ABOUT US</h1></Link>
                    <Link to={"/"} onClick={() => hideMenu()}><h1 className="ul">DONATE</h1></Link>
                    <div className="here">
